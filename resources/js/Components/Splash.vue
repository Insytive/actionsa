<template>
    <div class="container mx-auto py-8 mt-8">
        <div class="bg-white">
            <div class="text-4xl font-bold">Welcome to ActionSA</div>
        </div>
        ...
        <div class="flex flex-wrap">
            <div class="w-full lg:w-1/3">
                <div id="custom-card" class="p-6 mt-3">
                    <div class="flex items-center">
                        ...
                        <div
                            class="ml-3 text-md uppercase leading-7 font-semibold"
                        >
                            <jet-nav-link
            ...
            <div class="lg:px-3 xl:px-3 sm:p-0 w-full lg:w-1/3">
