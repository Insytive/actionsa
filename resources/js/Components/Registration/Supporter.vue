                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-full px-3">
                                ...
                                <input
                                    ...
                                    id="id_number"
                                    name="id_number"
                                    class="rounded-md border-solid border-2 border-green-100 appearance-none block w-full text-gray-700 py-3 px-4 mb-2 leading-tight focus:outline-none focus:border-green-500 focus:bg-white"
                                    tabindex="1"
                                    :class="{
                                        'border-red-100':
                                            submitted &&
                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-full px-3">
                                ...
                                <input
                                    ...
                                    id="lead_email"
                                    name="lead_email"
                                    class="rounded-md border-solid border-2 border-green-100 appearance-none block w-full text-gray-700  py-3 px-4 leading-tight focus:outline-none focus:border-green-500 focus:bg-white"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-wrap -mx-3 mb-3">
                            <div class="w-full px-3">
                                ...
                                <input
                                    ...
                                    name="phone"
                                    tabindex="4"
                                    class="rounded-md border-solid border-2 border-green-100 appearance-none block w-full text-gray-700 py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-green-500 focus:bg-white"
                                    :class="{
                                        'border-red-100':
                        ...
                        <div class="flex flex-wrap -mx-3 mb-3">
                            <div class="w-full px-3">
                                ...
                                <vue-google-autocomplete
                                    ...
                                    classname="rounded-md border-solid border-2 border-green-100 appearance-none block w-full text-gray-700 py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-green-500 focus:bg-white"
