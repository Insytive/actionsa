        ...
        <div id="custom-card" class="p-6 mt-3 card-2">
          <div class="flex items-center">
            ...
            >
              ...
              <path
                d="M18 4h-1v15h1c1.1 0 2-0.9 2-2v-11c0-1.1-0.9-2-2-2zM0 6v11c0 1.1 0.899 2 2 2h1v-15h-1c-1.101 0-2 0.9-2 2zM13.5 1.906c-0.681-0.316-1.889-0.906-3.519-0.906-1.633 0-2.8 0.59-3.481 0.906v2.094h-2.5v15h12v-15h-2.5v-2.094zM12 4h-4v-1.336c0.534-0.23 1.078-0.465 1.981-0.465s1.486 0.234 2.019 0.465v1.336z"
              ></path>
            </svg>

            <div class="ml-4 text-sm white leading-7 uppercase font-semibold">
              <a
          ...
          <div class="ml-12">
            ...
            <a href="/register" class="hover:no-underline" id="read-more">
              <div class="mt-4 flex items-center text-sm font-semibold">
                <div class="text-white">Join Volunteers</div>
