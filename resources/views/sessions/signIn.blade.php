...
<html lang="en">
    ...
    <head>
        ...
        <title>Sign in &mdash; ActionSA Persona</title>
                ...
                <div class="card o-hidden">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-center "
                            style="background-size: cover;background-image: linear-gradient(rgba(0,0,0,.85),rgba(0,0,0,.85) ), url({{asset('assets/images/photo-long-5.jpg')}}">
                            <div class="pr-3 auth-right">
                                <a class="btn btn-rounded btn-primary btn-email btn-block btn-icon-text"
                                    href="signup.html">
                                    <i class="i-Mail-with-At-Sign"></i> Sign up with Email
                                </a>
                                <a
                                    class="btn btn-rounded  btn-google btn-block btn-icon-text">
                                    <i class="i-Google-Plus"></i> Sign up with Google
                                </a>
                                <a
                                    class="btn btn-rounded  btn-block btn-icon-text btn-facebook">
