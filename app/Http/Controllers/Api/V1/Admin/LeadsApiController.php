...
class LeadsApiController extends Controller
{
    public function index()
    {
        ...
        return new LeadResource(Lead::with(['province', 'station', 'volunteer', 'user', 'member', 'employee', 'created_by'])->get());
    }
    ...
    public function show(Lead $lead)
    {
        ...
        return new LeadResource($lead->load(['province', 'station', 'volunteer', 'user', 'member', 'employee', 'created_by']));
    }
